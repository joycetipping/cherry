...
-->
  ...
  <p>
    <a href='<?php echo bloginfo('url'); ?>/'><?php bloginfo('name'); ?></a> is provided under the <a href='http://creativecommons.org/licenses/by-sa/3.0/'>Creative Commons Attribution-ShareAlike</a> license.
