...
-->
	...
	<p>&copy; <?php echo date('Y'); ?> <a href="<?php echo bloginfo('url'); ?>/"><?php bloginfo('name'); ?></a>. All rights reserved.
  ...
  <p>Cherry is a custom theme derived from <a href="http://www.ardamis.com/2007/06/03/apricot/">Apricot</a>, an excellent theme by <a href="http://www.ardamis.com/">Ardamis.com</a>.
